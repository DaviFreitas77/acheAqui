    ...
    <ScrollView style={{ backgroundColor: "#fff" }}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.inner}>
          <View style={{ gap: 10 }}>
            <Text style={styles.title}>Qual seu MaterialEscolar??</Text>
            <RNPickerSelect
          ...
          <View style={{ gap: 10, alignItems: 'center' }}>
            <Text style={styles.title}>Qual a cor do seu Material Escolar?</Text>
          ...
          <View style={{ alignItems: "center", gap: 10 }}>
            <Text style={styles.title}>Qual o tamanho do seu Material Escolar?</Text>
            <View style={styles.containerTags}>
